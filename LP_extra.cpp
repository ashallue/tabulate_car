...
void LargePreproduct::cars5_threaded_modified(string cars_file, long thread, long num_threads){
  //setup file
  ofstream output;
  output.open(cars_file);
  ...
  do{
    ...
    do{
      ...
      do{
        ...
        q = primes[i4];
        // check admissability, bump ahead until found
        while( q % p3 == 1 || q % p2 == 1 || q % p1 == 1 ){ q = primes[ ++i4 ]; }
        P4 = P3 * q;
        ...
        do{
          ...
          // find next q that makes P2 * q admissable
          do{ q = primes[ ++i4 ]; } while( q % p1 == 1 || q % p2 == 1 || q % p3 == 1 );
          P4 = P3 * q;
...
// faster admissable generation
void LargePreproduct::cars7_threaded_modified(string cars_file, long thread, long num_threads){
    //setup file
  ofstream output;
  output.open(cars_file);
  ...
  do{
    ...
    do{
      ...
      do{
        ...
        p4 = primes[i4];
        // check admissability
        while( p4 % p3 == 1 || p4 % p2 == 1 || p4 % p1 == 1 ){ p4 = primes[ ++i4 ]; }
        P4 = P3 * p4;
        ...
        do{
          ...
          // find start index for p5, discarding choices not admissable
          p5 = primes[i5];
          while( p5 % p4 == 1 || p5 % p3 == 1 || p5 % p2 == 1 || p5 % p1 == 1 ){ p5 = primes[ ++i5 ]; }
          P5 = P4 * p5;
          ...
          do{
            ...
            q = primes[i6];
            // check admissability, bump ahead until found
            while( q % p5 == 1 || q % p4 == 1 || q % p3 == 1 || q % p2 == 1 || q % p1 == 1 ){ q = primes[ ++i6 ]; }
            P6 = P5 * q;
            ...
            do{
              ...
              // find next q that makes P2 * q admissable
              do{ q = primes[ ++i6 ]; } while( q % p1 == 1 || q % p2 == 1 || q % p3 == 1 || q % p4 == 1 || q % p5 == 1 );
              P6 = P5 * q;

            } while(q < upper6); // end of do q

            // find next p5
            do{ p5 = primes[ ++i5 ]; } while( p5 % p1 == 1 || p5 % p2 == 1 || p5 % p3 == 1 || p5 % p4 == 1 );
            P5 = P4 * p5;
...
// faster admissability checking
void LargePreproduct::cars8_threaded_modified(string cars_file, long thread, long num_threads){
    //setup file
  ofstream output;
  output.open(cars_file);
      ...
      do{
        ...
        do{
          ...
          do{
            ...
            // find start index for p6, discarding choices not admissable
            p6 = primes[i6];
            while( p6 % p5 == 1 || p6 % p4 == 1 || p6 % p3 == 1 || p6 % p2 == 1 || p6 % p1 == 1){ p6 = primes[ ++i6 ]; }
            P6 = P5 * p6;
            ...
            do{
              ...
              q = primes[i7];
              // check admissability, bump ahead until found
              while( q % p6 == 1 || q % p5 == 1 || q % p4 == 1 || q % p3 == 1 || q % p2 == 1 || q % p1 == 1 ){ q = primes[ ++i7 ]; }
              P7 = P6 * q;
              ...
              do{
                ...
                // find next q that makes preproduct admissable
                do{ q = primes[ ++i7 ]; }while( q % p1 == 1 || q % p2 == 1 || q % p3 == 1 || q % p4 == 1 || q % p5 == 1 || q % p6 == 1 );
                P7 = P6 * q;

              } while(q < upper7); // end of do q

              // find next p6
              do{ p6 = primes[ ++i6 ]; }while( p6 % p1 == 1 || p6 % p2 == 1 || p6 % p3 == 1 || p6 % p4 == 1 || p6 % p5 == 1 );
              P6 = P5 * p6;
...
// faster admissability checking
void LargePreproduct::cars9_threaded_modified(string cars_file, long thread, long num_threads){
  //setup file
  ofstream output;
  output.open(cars_file);
        ...
        do{
          ...
          do{
            ...
            do{
              ...
              // find start index for p7, discarding choices not admissable
              p7 = primes[i7];
              while( p7 % p6 == 1 || p7 % p5 == 1 || p7 % p4 == 1 || p7 % p3 == 1 || p7 % p2 == 1 || p7 % p1 == 1 ){ p7 = primes[ ++i7 ]; }
              P7 = P6 * p7;
              ...
              do{
                ...
                q = primes[i8];
                // check admissability, bump ahead until found
                while( q % p7 == 1 || q % p6 == 1 || q % p5 == 1 || q % p4 == 1 || q % p3 == 1 || q % p2 == 1 || q % p1 == 1 ){ q = primes[ ++i8 ]; }
                P8 = P7 * q;
                ...
                do{
                  ...
                  // find next q that makes P7 * q admissable
                  do{ q = primes[ ++i8 ]; } while( q % p1 == 1 || q % p2 == 1 || q % p3 == 1 || q % p4 == 1 || q % p5 == 1 || q % p6 == 1 || q % p7 == 1 );
                  P8 = P7 * q;

                } while(q < upper8); // end of do q

                // find next p7
                do{ p7 = primes[ ++i7 ]; } while( p7 % p1 == 1 || p7 % p2 == 1 || p7 % p3 == 1 || p7 % p4 == 1 || p7 % p5 == 1 || p7 % p6 == 1 );
                P7 = P6 * p7;
